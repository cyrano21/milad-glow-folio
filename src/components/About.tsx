...
import { Code, Globe, Palette, Lightning, Database, DeviceMobile, Trophy, Heart } from 'phosphor-react';
...
const About = () => {
  ...
  const skills = [
    ...
    { icon: DeviceMobile, name: 'Mobile Dev', color: 'hsl(280 100% 75%)', level: 80 }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div ref={imageRef} className="relative">
            <div className="w-80 h-80 mx-auto relative">
              ...
              <div className="absolute inset-2 bg-gradient-secondary rounded-full glow-secondary opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>
              
              <div className="relative w-full h-full glass rounded-full p-2 overflow-hidden">
                <div className="w-full h-full bg-gradient-to-br from-muted to-card rounded-full flex items-center justify-center text-6xl text-gradient-primary relative">
                  M
                  {/* Floating micro-particles */}
                  <div className="absolute top-4 right-8 w-2 h-2 bg-primary/60 rounded-full animate-float"></div>
                  <div className="absolute bottom-6 left-6 w-1 h-1 bg-secondary/60 rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div ref={contentRef} className="space-y-8">
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed font-light">
                I'm a passionate <span className="text-gradient-primary font-medium">full-stack developer</span> with over 
                5 years of experience creating digital experiences that blend functionality with stunning visual design. 
                I specialize in <span className="text-gradient-secondary font-medium">modern web technologies</span> and 
            ...
            <div>
              <p className="text-lg text-muted-foreground leading-relaxed font-light">
                ...
                and has evolved into a love for crafting <span className="text-gradient-primary font-medium">premium, user-centric applications</span> 
              ...
              {stats.map((stat, index) => (
                <div key={stat.label} className="text-center group">
                  <div className="glass glass-hover p-4 rounded-xl transition-all duration-300 group-hover:scale-105">
                    <stat.icon size={24} className="mx-auto mb-2 text-gradient-primary" />
                    <div className="text-2xl font-light text-gradient-primary mb-1">{stat.number}</div>
